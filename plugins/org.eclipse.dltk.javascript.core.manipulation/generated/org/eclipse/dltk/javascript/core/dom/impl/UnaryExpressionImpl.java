 ...
 * </copyright>
 *
 * $Id: UnaryExpressionImpl.java,v 1.3 2011/04/18 08:29:42 apanchenk Exp $
 */
...
public class UnaryExpressionImpl extends ExpressionImpl implements UnaryExpression {
	...
	public NotificationChain basicSetArgument(Expression newArgument, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DomPackage.UNARY_EXPRESSION__ARGUMENT, oldArgument, newArgument);
	...
	public void setArgument(Expression newArgument) {
		if (newArgument != argument) {
			...
			if (argument != null)
				msgs = ((InternalEObject)argument).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DomPackage.UNARY_EXPRESSION__ARGUMENT, null, msgs);
			if (newArgument != null)
				msgs = ((InternalEObject)newArgument).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DomPackage.UNARY_EXPRESSION__ARGUMENT, null, msgs);
			msgs = basicSetArgument(newArgument, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomPackage.UNARY_EXPRESSION__ARGUMENT, newArgument, newArgument));
	}
	...
	public void setOperation(UnaryOperator newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomPackage.UNARY_EXPRESSION__OPERATION, oldOperation, operation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomPackage.UNARY_EXPRESSION__ARGUMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomPackage.UNARY_EXPRESSION__ARGUMENT:
				return getArgument();
			case DomPackage.UNARY_EXPRESSION__OPERATION:
				return getOperation();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DomPackage.UNARY_EXPRESSION__ARGUMENT:
				...
				return;
			case DomPackage.UNARY_EXPRESSION__OPERATION:
				setOperation((UnaryOperator)newValue);
				return;
		}
