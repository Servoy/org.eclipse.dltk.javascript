...
public class DomAdapterFactory extends AdapterFactoryImpl {
	...
	protected DomSwitch<Adapter> modelSwitch =
		new DomSwitch<Adapter>() {
			...
			@Override
			public Adapter caseForOfStatement(ForOfStatement object) {
			...
			@Override
			public Adapter caseMethodShorthandAssignment(MethodShorthandAssignment object) {
				return createMethodShorthandAssignmentAdapter();
			}
			@Override
			public Adapter caseBindingIdentifier(BindingIdentifier object) {
				return createBindingIdentifierAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.dltk.javascript.core.dom.ForOfStatement <em>For Of Statement</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.dltk.javascript.core.dom.MethodShorthandAssignment <em>Method Shorthand Assignment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMethodShorthandAssignmentAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.dltk.javascript.core.dom.BindingIdentifier <em>Binding Identifier</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBindingIdentifierAdapter() {
		return null;
	}
