 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.dltk.javascript.core.dom.impl.LetStatementImpl#getDeclarations <em>Declarations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LetStatementImpl extends StatementImpl implements LetStatement {
	...
	protected EClass eStaticClass() {
		return DomPackage.Literals.LET_STATEMENT;
	}
	...
	public EList<VariableDeclaration> getDeclarations() {
		if (declarations == null) {
			declarations = new EObjectContainmentEList<VariableDeclaration>(VariableDeclaration.class, this, DomPackage.LET_STATEMENT__DECLARATIONS);
		}
		return declarations;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DomPackage.LET_STATEMENT__DECLARATIONS:
