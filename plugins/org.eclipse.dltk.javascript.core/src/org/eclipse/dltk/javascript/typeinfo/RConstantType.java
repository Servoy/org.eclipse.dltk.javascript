...
public class RConstantType implements IRLocalType {

	private final IRType type;
	private final String name;
	private final ReferenceLocation location;

	public RConstantType(String name, IRType recordType,
	...
	public TypeCompatibility isAssignableFrom(IRType type) {
		...
		if (type instanceof RConstantType other) {
		...
		// if this is a record type hten it is the Enum class itself still, (so
		...
		if (type instanceof IRRecordType recordType) {
			...
			if (member != null) {
				IValueReference memberType = ConstantValue
						.of(new RConstantType(name, member.getType(),
								location));
