...
public class Parser2 {
    ...
    public Parser2(CompilerEnvirons compilerEnv) {
        this(compilerEnv, compilerEnv.getErrorReporter());
    }

    public Parser2(CompilerEnvirons compilerEnv, ErrorReporter errorReporter) {
...
//            root.setInStrictMode(true);
    ...
    private Identifier createNameNode(boolean checkActivation, int token) {
        ...
        Identifier name = new Identifier(beg, s);
    ...
    protected class PerFunctionVariables {
        ...
        PerFunctionVariables(FunctionNode fnNode) {
            savedCurrentScriptOrFn = Parser2.this.currentScriptOrFn;
            Parser2.this.currentScriptOrFn = fnNode;

            savedCurrentScope = Parser2.this.currentScope;
            Parser2.this.currentScope = fnNode;

            savedLabelSet = Parser2.this.labelSet;
            Parser2.this.labelSet = null;

            savedLoopSet = Parser2.this.loopSet;
            Parser2.this.loopSet = null;

            savedLoopAndSwitchSet = Parser2.this.loopAndSwitchSet;
            Parser2.this.loopAndSwitchSet = null;

            savedEndFlags = Parser2.this.endFlags;
            Parser2.this.endFlags = 0;

            savedInForInit = Parser2.this.inForInit;
            Parser2.this.inForInit = false;
        }

        void restore() {
            Parser2.this.currentScriptOrFn = savedCurrentScriptOrFn;
            Parser2.this.currentScope = savedCurrentScope;
            Parser2.this.labelSet = savedLabelSet;
            Parser2.this.loopSet = savedLoopSet;
            Parser2.this.loopAndSwitchSet = savedLoopAndSwitchSet;
            Parser2.this.endFlags = savedEndFlags;
            Parser2.this.inForInit = savedInForInit;
        }
    }
