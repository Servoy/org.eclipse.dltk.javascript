 ...
 * </copyright>
 *
 * $Id: StringLiteralImpl.java,v 1.3 2011/04/18 08:29:42 apanchenk Exp $
 */
...
public class StringLiteralImpl extends ExpressionImpl implements StringLiteral {
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomPackage.STRING_LITERAL__TEXT, oldText, text));
	}
